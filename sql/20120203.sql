...
CREATE TABLE `adminvisitlog` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=363 DEFAULT CHARSET=latin1 AUTO_INCREMENT=363 ;
...
INSERT INTO `answer` VALUES (7, '2', '否 (請填答第三、四題後即可停止作答)', 0, 0, 0, '8');
INSERT INTO `answer` VALUES (7, '1', '是(請跳答第四題)', 0, 0, 0, '5');
...
CREATE TABLE `problem` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=big5 AUTO_INCREMENT=10 ;
...
INSERT INTO `problem` VALUES (6, 1, 'dfghrtyh', 1, 4);
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=100541 DEFAULT CHARSET=utf8 AUTO_INCREMENT=100541 ;
...
INSERT INTO `user` VALUES ('2012', 100540, '許妙鸞', 'M993040038', '2', '3', '資訊工程學系碩士班', 'miaw52777@gmail.com', '0932747492', '["q_7a_1"]', '', '[]', '140.117.169.186', '2012-02-01 16:57:54', NULL);
