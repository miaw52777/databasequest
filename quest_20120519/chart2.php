...
$sql= "SELECT * FROM user WHERE (depart_id like 'K' || depart_id like 'A') && year='$y'";
$stu[6] = mysql_num_rows(mysql_query($sql));
   ...
   <script type="text/javascript">
      ...
      function onLoadCallback() {
        if (dataUrl.length > 0) {
		  ...
		  dataTable.setValue(6, 0, <? echo $stu[6]; ?>); 
          draw(dataTable);
        }
      }
      ...
      function draw(dataTable) {
        ...
        var options = {
          chxl: '1:|文學院|理學院|工學院|管理學院|海科院|社科院|教職員|',
          chxp: '',
          ...
          chco: 'AA0033',
		  chds:'0,<? echo $max+10; ?>',
          chd: 't:<? echo $stu[0]; ?>,<? echo $stu[1]; ?>,<? echo $stu[2]; ?>,<? echo $stu[3]; ?>,<? echo $stu[4]; ?>,<? echo $stu[5]; ?>,<? echo $stu[6]; ?>',
          chdl: '',
          chm: 'N,FF0000,0,-1,12',
          chtt: '院別統計'
        };
